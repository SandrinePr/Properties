...
const PropertyDetail: React.FC = () => {
  ...
  // Gallery koppeling: pakt de array uit WordPress of maakt een lege lijst
      ...
      <div className="pd-container">
        ...
        <div className="pd-grid-wrapper">
          ...
          <div className="pd-grid-main" onClick={() => setPhotoIndex(0)}>
            {allImages[0] ? <img src={allImages[0]} alt="Hero" referrerPolicy="no-referrer" /> : <div className="pd-placeholder">Geen foto</div>}
          </div>
